...
# Usage: ./compile.sh (run from latex_templete/ directory)
...
echo "Step 5/5: Copying PDF to root directory..."
if cp build/main.pdf main.pdf 2>/dev/null; then
  echo "  ✓ PDF copied"
  echo ""
  echo "=== Compilation Successful ==="
  echo "Output: latex_templete/main.pdf"
  ...
  echo "Output: latex_templete/build/main.pdf"
