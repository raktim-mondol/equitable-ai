...
$n=6$), a growth phase (2020--2022, $n=17$), and a sharp inflection
(2023--2024, $n=32$), with 18~additional studies appearing in
2025--2026~\citep{howard2021site, vaidya2024demographic,
komen2024batch}. Five studies had unreported publication years, totaling 78 studies ($6+17+32+18+5=78$). Research institutions in North America and Europe account for 84.6\% (66/78) of first/corresponding authors, with East Asia contributing most of the remainder~\citep{celi2022sources, musa2026cross},
  ...
  \begin{tikzpicture}[
    ...
    \node[databox, below=16mm of root] (sel)
        {\textbf{Selection / Sampling} ($n=8$)\\
         ${\sim}33/78$ on TCGA (42.3\%); acc.\ $95\%\!\to\!79\%$\\
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{@{}p{7.6cm} X@{}}
    ...
    Subgroup AUROC gap ($n=4$) \citep{vaidya2024demographic,zong2023medfair,lin2025contrastive,huang2025knowledge} &
    ...
    Expected Calibration Error (ECE) ($n=2$) \citep{roschewitz2023automatic,zong2023medfair} &
    ...
    Worst-group accuracy / AUROC ($n=6$) \citep{zong2023medfair,koh2021wilds,soltan2024challenges,huang2025knowledge,lin2025contrastive,xu2026spare} &
      Min performance across predefined subgroups; direct proxy for
      equity of service. \\
    Preserved-site CV ($n=4$) \citep{howard2021site,vaidya2024demographic,kheiri2025investigation} &
      Quadratic-programming partition keeping each site in a single
      fold; eliminates site leakage. \\
    In-dist.\ vs.\ OOD evaluation ($n=5+$) \citep{koh2021wilds,huang2025knowledge,zong2023medfair,asadiaghbolagh2024learning,komen2024batch} &
...
accuracy appeared in just six
(7.7\%, 95\% CI: 3.6--16.0\%)~\citep{zong2023medfair, koh2021wilds, soltan2024challenges}.
Expected calibration error (ECE) was reported in only two studies (2.6\%, 95\% CI: 0.7--9.1\%)~\citep{roschewitz2023automatic, zong2023medfair}, and
...
gap~\citep{vaidya2024demographic, zong2023medfair,
lin2025contrastive}, group fairness criteria (equalised odds, demographic
...
coverage)~\citep{roschewitz2023automatic, zong2023medfair,
...
fairness metric, and 7.7\% report worst-group
accuracy~\citep{zong2023medfair, vaidya2024demographic}. Effective mitigation strategies exist but remain under-adopted. Methods with strong empirical
